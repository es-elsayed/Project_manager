<header class="header white-bg fixed-top d-flex align-content-center flex-wrap">
    <!-- Logo -->
    <div class="logo">
        <a href="index.html" class="default-logo"><img src="{{ asset('assets/front/img/logo.png') }}" alt=""></a>
        <a href="index.html" class="mobile-logo"><img src="{{ asset('assets/front/img/mobile-logo.png') }}"
                alt=""></a>
    </div>
    <!-- End Logo -->
                    ...
                    <div class="main-header-left h-100 d-flex align-items-center">
                            ...
                            <a href="#" class="d-flex align-items-center" data-toggle="dropdown">
                                ...
                                <div class="user-profile d-xl-flex align-items-center d-none">
                                    ...
                                    <div class="user-avatar">
                                        <img src="{{ asset('assets/front/img/avatar/user.png') }}" alt="">
                                    </div>
                                    <!-- End User Avatar -->
                        ...
                        <div class="main-header-menu d-block d-lg-none">
                            <div class="header-toogle-menu">
                                ...
                                <img src="{{ asset('assets/front/img/menu.png') }}" alt="">
                            </div>
                        </div>
                        ...
                        <ul class="nav">
                            <li class="ml-0">
                                ...
                                <div class="main-header-language">
                                    <a href="#" data-toggle="dropdown">
                                        <img src="{{ asset('assets/front/img/svg/globe-icon.svg') }}" alt="">
                                    </a>
                                    <div class="dropdown-menu style--three">
                                        <a href="#">
                                            <span><img src="{{ asset('assets/front/img/usa.png') }}" alt=""></span>
                                            USA
                                        </a>
                                        <a href="#">
                                            <span><img src="{{ asset('assets/front/img/china.png') }}" alt=""></span>
                                            China
                                        </a>
                                        <a href="#">
                                        ...
                                        <a href="#">
                                            <span><img src="{{ asset('assets/front/img/spain.png') }}" alt=""></span>
                                            Spain
                                        </a>
                                        <a href="#">
                                        ...
                                        <a href="#">
                                            <span><img src="{{ asset('assets/front/img/france.png') }}"
                                                    alt=""></span>
                                            France
                                        </a>
                                        <a href="#">
                                            <span><img src="{{ asset('assets/front/img/algeria.png') }}"
                                                    alt=""></span>
                                            Algeria
                                        </a>
                                    </div>
                            ...
                            <li class="ml-0 d-none d-lg-flex">
                                ...
                                <div class="main-header-print">
                                    <a href="#">
                                        <img src="{{ asset('assets/front/img/svg/print-icon.svg') }}" alt="">
                                    </a>
                                </div>
                                    ...
                                    <form action="#" class="search-form">
                                        <div class="theme-input-group header-search">
                                            ...
                                            <button type="submit"><img
                                                    src="{{ asset('assets/front/img/svg/search-icon.svg') }}" alt=""
                                                    class="svg"></button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="main-header-message">
                                    <a href="#" class="header-icon" data-toggle="dropdown">
                                        <img src="{{ asset('assets/front/img/svg/message-icon.svg') }}" alt=""
                                            class="svg">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="dropdown-body">
                                            ...
                                            <a href="#" class="item-single d-flex media align-items-center">
                                                <div class="figure">
                                                    <img src="{{ asset('assets/front/img/avatar/m1.png') }}" alt="">
                                                ...
                                                <div class="content media-body">
                                                    ...
                                                    <p class="main-text">Donec dapibus mauris id odio
                                            ...
                                            <a href="#" class="item-single d-flex media align-items-center">
                                                <div class="figure">
                                                    <img src="{{ asset('assets/front/img/avatar/m2.png') }}" alt="">
                                                    <span class="avatar-status bg-teal"></span>
                                                </div>
                                                <div class="content media-body">
                                                    <div class="d-flex align-items-center mb-2">
                                            ...
                                            <a href="#" class="item-single d-flex media align-items-center">
                                                <div class="figure">
                                                    <img src="{{ asset('assets/front/img/avatar/m3.png') }}" alt="">
                                                    <span class="avatar-status bg-teal"></span>
                                                </div>
                                                <div class="content media-body">
                                                    <div class="d-flex align-items-center mb-2">
                                            ...
                                            <a href="#" class="item-single d-flex media align-items-center">
                                                <div class="figure">
                                                    <img src="{{ asset('assets/front/img/avatar/m4.png') }}" alt="">
                                                    <span class="avatar-status bg-teal"></span>
                                                </div>
                                                <div class="content media-body">
                                                    <div class="d-flex align-items-center mb-2">
                            ...
                            <li>
                                ...
                                <div class="main-header-notification">
                                    <a href="#" class="header-icon notification-icon" data-toggle="dropdown">
                                        <span class="count"
                                            data-bg-img="{{ asset('assets/front/img/count-bg.png') }}">22</span>
